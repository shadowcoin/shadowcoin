...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to ShadowCoin server / RPC client
            std::string strUsage = _("ShadowCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  shadowcoin [options]                     " + "\n" +
                  "  shadowcoin [options] <command> [params]  " + _("Send command to -server or shadowcoin") + "\n" +
                  "  shadowcoin [options] help                " + _("List commands") + "\n" +
                  "  shadowcoin [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: shadowcoin.pid)") + "\n" +
...
//    }
    ...
    // Make sure only a single shadowcoin process is using the data directory.
    boost::filesystem::path pathLockFile = GetDataDir() / ".lock";
    FILE* file = fopen(pathLockFile.string().c_str(), "a"); // empty lock file; created if it doesn't exist.
    if (file) fclose(file);
    static boost::interprocess::file_lock lock(pathLockFile.string().c_str());
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s.  ShadowCoin is probably already running."), GetDataDir().string().c_str()));
    ...
    // requested to kill shadowcoin-qt during the last operation. If so, exit.
