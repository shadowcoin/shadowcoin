...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // ShadowCoin: 7 days
static const int64 nTargetSpacing = 300; // ShadowCoin: 300 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal shadowcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Crimiean Crisis has been ongoing for 1 month, 1 week, and 3 days as of Genesis Block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // increase each by adding 2 to shadowcoin's value.
